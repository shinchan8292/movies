...
API_ID = int(environ.get('API_ID', '7518064039'))
API_HASH = environ.get('API_HASH', 'dcf36e82600f9bc66857ae14607463c8')
BOT_TOKEN = environ.get('BOT_TOKEN', '8186007436:AAGxIQkVeZUBuG5i1-ims-BmQAiaspVaXCM')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Shinchann:shinchann@shinchann.pn7us.mongodb.net/?retryWrites=true&w=majority&appName=Shinchann")
DATABASE_NAME = environ.get('DATABASE_NAME', "shinchann")
